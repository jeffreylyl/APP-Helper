package android.app.demo.header;
...
import android.app.demo.progressindicator.*;

public class MyHeader extends FrameLayout implements PtrUIHandler {
    ...
    private AVLoadingIndicatorView arrow;
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.ptr_myheader, this);
        ...
        arrow = (AVLoadingIndicatorView) header.findViewById(R.id.arrow);
        arrow.setIndicatorId(ProgressStyle.BallPulseRise);
        arrow.setIndicatorColor(R.color.colorPrimary);
        resetView();
    }
